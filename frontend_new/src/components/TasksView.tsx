...
export default function TasksView({ 
  ...
  const updateLocalTaskField = (taskId: string, field: keyof Task, value: any) => {
    ...
    // Call onUpdateTask for slider and select changes immediately
    if (field === 'progress' || field === 'status' || field === 'priority' || field === 'projectId' || field === 'assigneeId') {
      if (onUpdateTask) {
                ...
                <div className="flex items-center gap-2">
                  <button 
                    onClick={() => {
                      ...
                      setIsDrawerEditing(!isDrawerEditing);
                    }}
